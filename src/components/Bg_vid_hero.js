...
const BackgroundHero = () => {
  return (
    ...
    <h2 className="flex pt-5 items-center justify-center text-center text-2xl font-bold">Watch some<a href="https://www.youtube.com/watch?v=z_s1Nb3JwDY&ab_channel=JoshuaBlackmore" className='text-yellow-300 text-4xl hover:text-5xl hover:text-pink-500 px-2 transition-all'>video</a>for now</h2>
    </div>
    </div>
    </div>
  )
