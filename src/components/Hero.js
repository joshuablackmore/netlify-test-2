...
const Hero = () => {
  return (
    <div className='flex items-center justify-center h-[100dvh] bg-center bg-cover custom-img overflow-hidden'>
        ...
        <h2 className="flex pt-5 items-center justify-center text-center text-2xl font-bold">Watch some<a href="#videos" className='text-yellow-300 text-4xl hover:text-pink-500 px-2'>videos</a>for now</h2>
        </div>
    </div>
  )
}
